...
export const Navbar = () => {
  ...
  return (
    <header
      ref={navContainerRef}
      className="fixed roun inset-x-0 top-4 mx-9 z-50 h-16 border-none transition-all duration-700 sm:inset-x-6"
    >
      <div className="absolute top-1/2 w-full -translate-y-1/2">
        <nav className="flex px-7 mx- size-full items-center justify-between p-4">
